...
public class Main {
	public static void main(String[] args) {
		...
		while (kon == 1) {
			...
			String o1 = "+";
			while (try3 == 1) {
				System.out.print("Zadejte matematické znaménko (+, -, *, /, m mocnina, o odmocnina): ");
			...
			case "o":
				if (c2 <= 0) {
					System.out.println("Nejde mít nultou èi menší odmocninu!");
					break;
				} else {
			...
			while (try4 == 1) {
				try {
					System.out.print(" chcete zadat jiný pøíklad (Ano = 1, Ne = 2): ");
